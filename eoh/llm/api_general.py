    ...
    def get_response(self, prompt_content):
        ...
        while True:
            ...
            try:
                ...
                prompt = len(prompt_content)
                print(f"completion_tokens: {completion}, prompt_tokens: {prompt}")
                InterfaceAPI.completion_tokens += completion
                InterfaceAPI.prompt_tokens += prompt
                break
            except:
                if self.debug_mode:
