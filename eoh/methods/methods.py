...
class Methods():
    def __init__(self,paras,problem) -> None:
        ...
        if paras.selection == "prob_rank": # default
        ...
        if paras.management == "pop_greedy": # default
    ...
    def get_method(self):
        ...
        elif self.paras.method == "aig":   
            from .aig.aig import AIG
            return AIG(self.paras,self.problem,self.select,self.manage)
