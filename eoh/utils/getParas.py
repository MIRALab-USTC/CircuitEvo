...
class Paras():
    def __init__(self):
        ...
        ### AIG settings  ###
        #####################
        self.truth_file_path = None
        self.input_number = None
        self.output_number = None
        self.writer = None
        self.use_fx = None
        self.local_search = None
        self.random_generated = None
        self.sample_num = None
        self.shannon_decomposition = None
        self.prune = None
        self.reflect = None
        self.LLM_generation_initial = None
        self.legalized_parent = None
    ...
    def set_ec(self):    
        ...
        if self.ec_operators == None:
            if self.method == 'eoh' or self.method == 'aig':
    ...
    def set_evaluation(self):
        ...
        if self.problem == 'bp_online':
            ...
            self.eva_timeout = 20
        elif self.problem == 'AIG':
            self.eva_timeout = 20
    
    def set_AIG(self):
        if self.truth_file_path is not None:
            input_number, output_number = read_val(self.truth_file_path)
